...
func edit_item_quantity(name, quantity, isAdding):
	var resources = {"1": self.get_item_by_name("copper"),
					"2": self.get_item_by_name("coal"),
					"3": self.get_item_by_name("iron"),
					"4": self.get_item_by_name("lead"),
					"5": self.get_item_by_name("oil"),
					"6": self.get_item_by_name("uranium")}
